...
def _(baseimage):
    ...
    _phi = pi / 6
    baseimage(a1=[cos(_phi), sin(_phi)], a2=[-sin(_phi), cos(_phi)])
    return cos, pi, sin


@app.cell
def _(baseimage, cos, pi, sin):
    _phi = pi / 6
    baseimage(a1=[cos(_phi), sin(_phi)], a2=[-2 * sin(_phi), 2 * cos(_phi)])
    return
